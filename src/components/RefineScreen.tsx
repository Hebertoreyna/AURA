  ...
  const getRecommendations = () => {
    ...
    if (zone === 'corporal') {
      ...
      if (concern === 'redness' || skinType === 'sensitive') {
        ...
        rituals = RITUALS.filter(r => ['r5','r14'].includes(r.id));
        prescription = 'La hiperpigmentación requiere renovación celular y activos iluminadores. La microdermoabrasión y el Facial Personalizado (que incluye la aparatología que Anel determine necesaria) son tus mejores aliados.';
